...
<p align="center">"중고 거래부터 동네 정보까지"<br> <span style=color:#ff8a3d>당근마켓</span>을 모티브로 만든 중고거래 플팻폼 API 서버 프로젝트입니다.</p>

<br>
<br>

<h4>월 1000만명 이상 사용하고 있는 <span style=color:#ff8a3d>당근마켓</span>은 어떻게 만들어진 것일까요? </h4>
<p>
...
<h5>단순히 <span style=color:#ff8a3d>당근마켓</span>의 기능만 구현하지 않았습니다!</h5>
